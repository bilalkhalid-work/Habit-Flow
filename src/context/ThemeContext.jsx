...
const themes = {
  ...
  sakura: {
    ...
    sidebar: "bg-pink-100/30 border-pink-300/20",
    card: "bg-white/20 border-white/30 backdrop-blur-md",
    cardSolid: "bg-white/25",
    ...
    input: "bg-white/50 border-pink-200 text-gray-800 placeholder-gray-400",
  ...
  autumn: {
    ...
    sidebar: "bg-[#1a0800]/75 border-orange-900/30",
